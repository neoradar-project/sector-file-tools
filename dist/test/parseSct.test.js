...
import { parseSct, Position, Color } from '../src';
const empty = {
    info: {},
    defines: {},
    vor: [],
...
1
    ...
    it('read RUNWAYs', function () {
        expect(parseSct('[RUNWAY]\n01L 19R 013 193 N060.11.06.000 E011.04.25.478 N060.12.57.841 E011.05.29.990 ENGM ; test comment')).to.deep.equal({
            ...empty,
            runways: [
                {
                    id: '01L',
...
//# sourceMappingURL=parseSct.test.js.map